...
fn profile_distr<D: Distribution>(distr: D, map_size: usize, c: &mut Criterion) {
    ...
    profile_hashonly::<xxhash_rust::xxh3::Xxh3DefaultBuilder, _>("xxh3", distr.clone(), c);
    ...
    // profile_lookup_miss::<xxhash_rust::xxh3::Xxh3DefaultBuilder, _>("xxh3", distr.clone(), map_size, c);
    ...
    // profile_lookup_hit::<xxhash_rust::xxh3::Xxh3DefaultBuilder, _>("xxh3", distr.clone(), map_size, c);
    ...
    // profile_set_build::<xxhash_rust::xxh3::Xxh3DefaultBuilder, _>("xxh3", distr.clone(), map_size, c);
